...
`crps(fcst, obs, at=NULL, after=NULL, summarize=TRUE)` is like `log_score()`, but without the `bw` parameter.
Because it works using the CDF of a distribution and not the PDF, it does not rely on kernel density estimation.
