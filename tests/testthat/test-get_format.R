...
test_that("get_time_type() works", {
  expect_error(casteval:::get_time_type(list()), "no times present")
  expect_equal(
  ...
  expect_error(
    casteval:::get_time_type(list(1, lubridate::ymd("2024-01-01"))),
    "inconsistent"
  )
  expect_error(
    casteval:::get_time_type(list("January 1", "January 2")),
    "unsupported"
  )
})
