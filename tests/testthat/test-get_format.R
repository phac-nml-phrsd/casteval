...
test_that("get_obs_format() works", {
  expect_equal(get_obs_format(data.frame(time=1:3, obs=4:6)), "numeric")
  expect_equal(get_obs_format(data.frame(time=lubridate::ymd("2024-01-01"), obs=10)), "date")
  expect_equal(get_obs_format(data.frame(time=lubridate::ymd_hms("2024-01-01_01:02:03"), obs=10)), "date-time")
})
